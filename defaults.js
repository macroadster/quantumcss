...
const utilityMaps = {
  ...
  'glass': {
    property: ['background', 'backdrop-filter', '-webkit-backdrop-filter', 'border', 'box-shadow'], 
  ...
  'dialog-overlay': {
    ...
    value: ['fixed', '0', '0', '100vw', '100vh', 'rgba(0, 0, 0, 0.6)', 'blur(12px)', 'flex', 'center', 'center', '1000']
  },
  'dialog-content': {
    property: ['background', 'backdrop-filter', 'border', 'border-radius', 'width', 'max-width', 'box-shadow', 'overflow', 'position'],
    value: ['rgba(15, 15, 30, 0.9)', 'blur(20px)', '1px solid rgba(255, 255, 255, 0.1)', '1.5rem', '90%', '600px', '0 25px 50px -12px rgba(0, 0, 0, 0.5)', 'hidden', 'relative']
  },
  'dropdown-menu': {
    property: ['background', 'backdrop-filter', 'border', 'border-radius', 'padding', 'box-shadow', 'min-width', 'z-index', 'margin-top'],
    value: ['rgba(15, 15, 30, 0.85)', 'blur(20px)', '1px solid rgba(255, 255, 255, 0.1)', '1rem', '0.5rem', '0 20px 40px rgba(0,0,0,0.4)', '200px', '1000', '0.5rem']
  },
  'dropdown-item': {
  ...
  // Tooltip
  'tooltip': {
    property: ['position', 'bottom', 'left', 'transform', 'padding', 'background', 'backdrop-filter', 'border', 'border-radius', 'color', 'font-size', 'white-space', 'pointer-events', 'opacity', 'transition', 'z-index', 'box-shadow'],
    value: ['absolute', '125%', '50%', 'translateX(-50%)', '0.5rem 0.75rem', 'rgba(0, 212, 255, 0.1)', 'blur(12px)', '1px solid rgba(0, 212, 255, 0.2)', '0.5rem', '#fff', '0.75rem', 'nowrap', 'none', '0', 'all 0.2s ease', '1000', '0 4px 15px rgba(0, 212, 255, 0.2)']
  }
};
