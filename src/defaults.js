...
const utilityMaps = {
  ...
  'gap-1': { property: 'gap', value: 'var(--q-space-1)' },
  'gap-2': { property: 'gap', value: 'var(--q-space-2)' },
  'gap-3': { property: 'gap', value: 'var(--q-space-3)' },
  'gap-4': { property: 'gap', value: 'var(--q-space-4)' },
  'gap-5': { property: 'gap', value: 'var(--q-space-5)' },
  'gap-6': { property: 'gap', value: 'var(--q-space-6)' },
  'gap-8': { property: 'gap', value: 'var(--q-space-8)' },
  'gap-10': { property: 'gap', value: 'var(--q-space-10)' },
  'gap-12': { property: 'gap', value: 'var(--q-space-12)' },
  'gap-16': { property: 'gap', value: 'var(--q-space-16)' },
  'gap-20': { property: 'gap', value: 'var(--q-space-20)' },
  'gap-24': { property: 'gap', value: 'var(--q-space-24)' },
  'gap-32': { property: 'gap', value: 'var(--q-space-32)' },

  'm-0': { property: 'margin', value: '0px' },
  'm-1': { property: 'margin', value: 'var(--q-space-1)' },
  'm-2': { property: 'margin', value: 'var(--q-space-2)' },
  'm-3': { property: 'margin', value: 'var(--q-space-3)' },
  'm-4': { property: 'margin', value: 'var(--q-space-4)' },
  'm-5': { property: 'margin', value: 'var(--q-space-5)' },
  'm-6': { property: 'margin', value: 'var(--q-space-6)' },
  'm-8': { property: 'margin', value: 'var(--q-space-8)' },
  'm-10': { property: 'margin', value: 'var(--q-space-10)' },
  'm-12': { property: 'margin', value: 'var(--q-space-12)' },
  'm-16': { property: 'margin', value: 'var(--q-space-16)' },
  'm-20': { property: 'margin', value: 'var(--q-space-20)' },
  'm-24': { property: 'margin', value: 'var(--q-space-24)' },
  'm-32': { property: 'margin', value: 'var(--q-space-32)' },
  'm-auto': { property: 'margin', value: 'auto' },

  'mx-0': { property: 'margin-inline', value: '0px' },
  'mx-1': { property: 'margin-inline', value: 'var(--q-space-1)' },
  'mx-2': { property: 'margin-inline', value: 'var(--q-space-2)' },
  'mx-4': { property: 'margin-inline', value: 'var(--q-space-4)' },
  'mx-auto': { property: 'margin-inline', value: 'auto' },

  'my-0': { property: 'margin-block', value: '0px' },
  'my-1': { property: 'margin-block', value: 'var(--q-space-1)' },
  'my-2': { property: 'margin-block', value: 'var(--q-space-2)' },
  'my-4': { property: 'margin-block', value: 'var(--q-space-4)' },
  'my-auto': { property: 'margin-block', value: 'auto' },

  'mt-0': { property: 'margin-top', value: '0px' },
  'mt-1': { property: 'margin-top', value: 'var(--q-space-1)' },
  'mt-2': { property: 'margin-top', value: 'var(--q-space-2)' },
  'mt-4': { property: 'margin-top', value: 'var(--q-space-4)' },
  'mt-6': { property: 'margin-top', value: 'var(--q-space-6)' },
  'mt-8': { property: 'margin-top', value: 'var(--q-space-8)' },
  'mt-16': { property: 'margin-top', value: 'var(--q-space-16)' },

  'mb-0': { property: 'margin-bottom', value: '0px' },
  'mb-1': { property: 'margin-bottom', value: 'var(--q-space-1)' },
  'mb-2': { property: 'margin-bottom', value: 'var(--q-space-2)' },
  'mb-4': { property: 'margin-bottom', value: 'var(--q-space-4)' },
  'mb-6': { property: 'margin-bottom', value: 'var(--q-space-6)' },
  'mb-8': { property: 'margin-bottom', value: 'var(--q-space-8)' },
  'mb-16': { property: 'margin-bottom', value: 'var(--q-space-16)' },

  'ml-0': { property: 'margin-inline-start', value: '0px' },
  'ml-1': { property: 'margin-inline-start', value: 'var(--q-space-1)' },
  'ml-2': { property: 'margin-inline-start', value: 'var(--q-space-2)' },
  'ml-4': { property: 'margin-inline-start', value: 'var(--q-space-4)' },
  'ml-auto': { property: 'margin-inline-start', value: 'auto' },

  'mr-0': { property: 'margin-inline-end', value: '0px' },
  'mr-1': { property: 'margin-inline-end', value: 'var(--q-space-1)' },
  'mr-2': { property: 'margin-inline-end', value: 'var(--q-space-2)' },
  'mr-4': { property: 'margin-inline-end', value: 'var(--q-space-4)' },

  'p-0': { property: 'padding', value: '0px' },
  'p-1': { property: 'padding', value: 'var(--q-space-1)' },
  'p-2': { property: 'padding', value: 'var(--q-space-2)' },
  'p-3': { property: 'padding', value: 'var(--q-space-3)' },
  'p-4': { property: 'padding', value: 'var(--q-space-4)' },
  'p-5': { property: 'padding', value: 'var(--q-space-5)' },
  'p-6': { property: 'padding', value: 'var(--q-space-6)' },
  'p-8': { property: 'padding', value: 'var(--q-space-8)' },
  'p-10': { property: 'padding', value: 'var(--q-space-10)' },
  'p-12': { property: 'padding', value: 'var(--q-space-12)' },
  'p-16': { property: 'padding', value: 'var(--q-space-16)' },
  'p-20': { property: 'padding', value: 'var(--q-space-20)' },
  'p-24': { property: 'padding', value: 'var(--q-space-24)' },
  'p-32': { property: 'padding', value: 'var(--q-space-32)' },

  'px-0': { property: 'padding-inline', value: '0px' },
  'px-1': { property: 'padding-inline', value: 'var(--q-space-1)' },
  'px-2': { property: 'padding-inline', value: 'var(--q-space-2)' },
  'px-4': { property: 'padding-inline', value: 'var(--q-space-4)' },
  'px-6': { property: 'padding-inline', value: 'var(--q-space-6)' },
  'px-8': { property: 'padding-inline', value: 'var(--q-space-8)' },
  'px-12': { property: 'padding-inline', value: 'var(--q-space-12)' },

  'py-0': { property: 'padding-block', value: '0px' },
  'py-1': { property: 'padding-block', value: 'var(--q-space-1)' },
  'py-2': { property: 'padding-block', value: 'var(--q-space-2)' },
  'py-4': { property: 'padding-block', value: 'var(--q-space-4)' },
  'py-6': { property: 'padding-block', value: 'var(--q-space-6)' },
  'py-8': { property: 'padding-block', value: 'var(--q-space-8)' },
  'py-16': { property: 'padding-block', value: 'var(--q-space-16)' },
  'py-24': { property: 'padding-block', value: 'var(--q-space-24)' },

  'pt-0': { property: 'padding-top', value: '0px' },
  'pt-4': { property: 'padding-top', value: 'var(--q-space-4)' },
  'pt-6': { property: 'padding-top', value: 'var(--q-space-6)' },
  'pt-8': { property: 'padding-top', value: 'var(--q-space-8)' },

  'pb-0': { property: 'padding-bottom', value: '0px' },
  'pb-4': { property: 'padding-bottom', value: 'var(--q-space-4)' },
  'pb-6': { property: 'padding-bottom', value: 'var(--q-space-6)' },
  'pb-8': { property: 'padding-bottom', value: 'var(--q-space-8)' },
  'pb-12': { property: 'padding-bottom', value: 'var(--q-space-12)' },

  'pl-0': { property: 'padding-inline-start', value: '0px' },
  'pl-4': { property: 'padding-inline-start', value: 'var(--q-space-4)' },
  'pl-6': { property: 'padding-inline-start', value: 'var(--q-space-6)' },
  'pl-12': { property: 'padding-inline-start', value: 'var(--q-space-12)' },

  'pr-0': { property: 'padding-inline-end', value: '0px' },
  'pr-4': { property: 'padding-inline-end', value: 'var(--q-space-4)' },
  'pr-6': { property: 'padding-inline-end', value: 'var(--q-space-6)' },
  ...
  'rounded-sm': { property: 'border-radius', value: 'var(--q-radius-sm)' },
  'rounded-md': { property: 'border-radius', value: 'var(--q-radius-md)' },
  'rounded-lg': { property: 'border-radius', value: 'var(--q-radius-lg)' },
  'rounded-xl': { property: 'border-radius', value: 'var(--q-radius-xl)' },
  'rounded-2xl': { property: 'border-radius', value: 'var(--q-radius-2xl)' },
  'rounded-3xl': { property: 'border-radius', value: 'var(--q-radius-3xl)' },
  'rounded-full': { property: 'border-radius', value: 'var(--q-radius-full)' },
  ...
  'w-1': { property: 'width', value: 'var(--q-space-1)' },
  'w-2': { property: 'width', value: 'var(--q-space-2)' },
  'w-3': { property: 'width', value: 'var(--q-space-3)' },
  'w-4': { property: 'width', value: 'var(--q-space-4)' },
  'w-5': { property: 'width', value: 'var(--q-space-5)' },
  'w-6': { property: 'width', value: 'var(--q-space-6)' },
  'w-8': { property: 'width', value: 'var(--q-space-8)' },
  'w-10': { property: 'width', value: 'var(--q-space-10)' },
  'w-12': { property: 'width', value: 'var(--q-space-12)' },
  'w-16': { property: 'width', value: 'var(--q-space-16)' },
  'w-20': { property: 'width', value: 'var(--q-space-20)' },
  'w-24': { property: 'width', value: 'var(--q-space-24)' },
  'w-32': { property: 'width', value: 'var(--q-space-32)' },

  'h-auto': { property: 'height', value: 'auto' },
  'h-full': { property: 'height', value: '100%' },
  'h-screen': { property: 'height', value: '100vh' },
  'h-dvh': { property: 'height', value: '100dvh' },
  'h-fit': { property: 'height', value: 'fit-content' },

  'h-0': { property: 'height', value: '0px' },
  'h-1': { property: 'height', value: 'var(--q-space-1)' },
  'h-2': { property: 'height', value: 'var(--q-space-2)' },
  'h-3': { property: 'height', value: 'var(--q-space-3)' },
  'h-4': { property: 'height', value: 'var(--q-space-4)' },
  'h-5': { property: 'height', value: 'var(--q-space-5)' },
  'h-6': { property: 'height', value: 'var(--q-space-6)' },
  'h-8': { property: 'height', value: 'var(--q-space-8)' },
  'h-10': { property: 'height', value: 'var(--q-space-10)' },
  'h-12': { property: 'height', value: 'var(--q-space-12)' },
  'h-16': { property: 'height', value: 'var(--q-space-16)' },
  'h-20': { property: 'height', value: 'var(--q-space-20)' },
  'h-24': { property: 'height', value: 'var(--q-space-24)' },
  'h-32': { property: 'height', value: 'var(--q-space-32)' },
  ...
  'cq-inline': { property: 'container-type', value: 'inline-size' },
  'cq-normal': { property: 'container-type', value: 'normal' },
  'cq-size': { property: 'container-type', value: 'size' },
