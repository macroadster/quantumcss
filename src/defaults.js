...
const utilityMaps = {
  ...
  'btn-secondary': 'btn-base theme-glass-dark h-12 px-6 border-white/15 focus-glow',
  'input-starlight': 'input-base theme-glass-dark h-12 px-4 border-white/15 focus-glow',
  'textarea-starlight': 'input-base theme-glass-dark p-4 min-h-32 border-white/15 focus-glow',
  'checkbox-starlight': 'btn-base theme-glass-dark w-5 h-5 border-white/20 focus-glow',
  'search-container': 'relative block w-full',
    'search-input': 'pl-12 w-full focus-glow',
    ...
    'starlight-search': 'search-container theme-glass-dark rounded-xl focus-glow',
