...
const utilityMaps = {
  ...
  'mx-1': { property: ['margin-left', 'margin-right'], value: ['var(--q-space-1)', 'var(--q-space-1)'] },
  'mx-2': { property: ['margin-left', 'margin-right'], value: ['var(--q-space-2)', 'var(--q-space-2)'] },
  'mx-4': { property: ['margin-left', 'margin-right'], value: ['var(--q-space-4)', 'var(--q-space-4)'] },
  'mx-auto': { property: ['margin-left', 'margin-right'], value: ['auto', 'auto'] },

  'my-0': { property: ['margin-top', 'margin-bottom'], value: ['0px', '0px'] },
  'my-1': { property: ['margin-top', 'margin-bottom'], value: ['var(--q-space-1)', 'var(--q-space-1)'] },
  'my-2': { property: ['margin-top', 'margin-bottom'], value: ['var(--q-space-2)', 'var(--q-space-2)'] },
  'my-4': { property: ['margin-top', 'margin-bottom'], value: ['var(--q-space-4)', 'var(--q-space-4)'] },
  ...
  'ml-1': { property: 'margin-left', value: 'var(--q-space-1)' },
  'ml-2': { property: 'margin-left', value: 'var(--q-space-2)' },
  'ml-4': { property: 'margin-left', value: 'var(--q-space-4)' },
  'ml-auto': { property: 'margin-left', value: 'auto' },

  'mr-0': { property: 'margin-right', value: '0px' },
  'mr-1': { property: 'margin-right', value: 'var(--q-space-1)' },
  'mr-2': { property: 'margin-right', value: 'var(--q-space-2)' },
  'mr-4': { property: 'margin-right', value: 'var(--q-space-4)' },
  ...
  'px-1': { property: ['padding-left', 'padding-right'], value: ['var(--q-space-1)', 'var(--q-space-1)'] },
  'px-2': { property: ['padding-left', 'padding-right'], value: ['var(--q-space-2)', 'var(--q-space-2)'] },
  'px-4': { property: ['padding-left', 'padding-right'], value: ['var(--q-space-4)', 'var(--q-space-4)'] },
  'px-6': { property: ['padding-left', 'padding-right'], value: ['var(--q-space-6)', 'var(--q-space-6)'] },
  'px-8': { property: ['padding-left', 'padding-right'], value: ['var(--q-space-8)', 'var(--q-space-8)'] },
  'px-12': { property: ['padding-left', 'padding-right'], value: ['var(--q-space-12)', 'var(--q-space-12)'] },

  'py-0': { property: ['padding-top', 'padding-bottom'], value: ['0px', '0px'] },
  'py-1': { property: ['padding-top', 'padding-bottom'], value: ['var(--q-space-1)', 'var(--q-space-1)'] },
  'py-2': { property: ['padding-top', 'padding-bottom'], value: ['var(--q-space-2)', 'var(--q-space-2)'] },
  'py-4': { property: ['padding-top', 'padding-bottom'], value: ['var(--q-space-4)', 'var(--q-space-4)'] },
  'py-6': { property: ['padding-top', 'padding-bottom'], value: ['var(--q-space-6)', 'var(--q-space-6)'] },
  'py-8': { property: ['padding-top', 'padding-bottom'], value: ['var(--q-space-8)', 'var(--q-space-8)'] },
  'py-16': { property: ['padding-top', 'padding-bottom'], value: ['var(--q-space-16)', 'var(--q-space-16)'] },
  'py-24': { property: ['padding-top', 'padding-bottom'], value: ['var(--q-space-24)', 'var(--q-space-24)'] },
  ...
  'pl-4': { property: 'padding-left', value: 'var(--q-space-4)' },
  'pl-6': { property: 'padding-left', value: 'var(--q-space-6)' },
  'pl-12': { property: 'padding-left', value: 'var(--q-space-12)' },

  'pr-0': { property: 'padding-right', value: '0px' },
  'pr-4': { property: 'padding-right', value: 'var(--q-space-4)' },
  'pr-6': { property: 'padding-right', value: 'var(--q-space-6)' },
